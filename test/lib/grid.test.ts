...
describe('Grid lib stuff', () => {
    ...
    describe('getColunmSlotAvailableIndex', () => {
        it('should return a valid index', () => {
            const result = getColunmSlotAvailableIndex([CoinSlot.Blank, CoinSlot.Blank, CoinSlot.Blank, CoinSlot.Player1]);
    ...
    describe('getTransposedGrid', () => {
        it('should return an empty grid', () => {
            ...
            expect(result[0][0]).equal(CoinSlot.Player1);
            expect(result[1][0]).equal(CoinSlot.Player1);
            expect(result[2][0]).equal(CoinSlot.Player1);
            expect(result[3][0]).equal(CoinSlot.Player1);
        });
    });
